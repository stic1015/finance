export const enUS = {
  ...
  overview: {
    ...
    description: 'Check source quality, focus symbols, market momentum, and related news before going into single-stock research.',
  ...
  strategy: {
    ...
    description: 'Choose a template, tune parameters, and compare cumulative return, drawdown, Sharpe, and curve stability.',
